...
public class FailurePaymentFlow extends LearnexaWrappers {
	
	public FailurePaymentFlow(RemoteWebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test;
	...
	public FailurePaymentFlow clickCreateCourseButton()
	{
	...
	public FailurePaymentFlow clickPresentationContent()
	{
	...
	public FailurePaymentFlow clickselectItem()
	{
	...
	public FailurePaymentFlow clickApply() throws InterruptedException
	{
		Thread.sleep(4000);
	...
	public FailurePaymentFlow clickCourseTitle() throws InterruptedException
	{
		Thread.sleep(4000);
	...
	public FailurePaymentFlow clickDescription() throws InterruptedException {
		driver.switchTo().frame("course_raw_data_ifr").findElement(By.id("tinymce")).sendKeys("Testing Automation");
		Thread.sleep(4000);
		driver.switchTo().parentFrame();
		return new FailurePaymentFlow(driver, test);
	}
	
		//Click on Price radio button => Failure payment scenario
		public FailurePaymentFlow clickPriceButton(String Title) throws InterruptedException
		{
			Thread.sleep(4000);
			String pricevalue="3.61";
		...
		//Click on Price radio button => Card declined scenario
		public FailurePaymentFlow clickPriceButton1(String Title) throws InterruptedException
		{
			Thread.sleep(4000);
		...
		//Click on Price radio button => Charge Back Payment scenario
				public FailurePaymentFlow clickPriceButton2(String Title) throws InterruptedException
				{
					Thread.sleep(4000);
		...
		public FailurePaymentFlow clickSave1Button() throws InterruptedException {
			...
			public FailurePaymentFlow clickCatalogMenu() throws InterruptedException {
				Thread.sleep(3000);
			...
			public FailurePaymentFlow enterText(String Title) throws InterruptedException, AWTException {
			...
			public FailurePaymentFlow AddToCart() throws InterruptedException {
				clickByXpath(prop.getProperty("Payments.AddToCart.Xpath"));
				return this;
			}
			
			public FailurePaymentFlow clickPay() throws InterruptedException {
				Thread.sleep(4000);
			...
			public FailurePaymentFlow switchframes() {
			...
			public FailurePaymentFlow cardNumber() throws InterruptedException {
			...
			public FailurePaymentFlow MonthYearCVV() throws InterruptedException {
				String Testdata3 = "10";
				String Testdata4 = "20";
			...
			public FailurePaymentFlow BillingAddress() {
			...
			public FailurePaymentFlow country(){
				String value="3";
			...
			public FailurePaymentFlow NextButton() throws InterruptedException {
				Thread.sleep(3000);
			...
			public FailurePaymentFlow emailaddress(String email) throws InterruptedException {
