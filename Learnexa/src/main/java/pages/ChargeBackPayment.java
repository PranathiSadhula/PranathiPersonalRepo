...
public class ChargeBackPayment extends LearnexaWrappers {

	public ChargeBackPayment(RemoteWebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test;
		
}
	//click on Course button
			public ChargeBackPayment clickCreateCourseButton()
			{
			...
			public ChargeBackPayment clickPresentationContent()
			{
			...
			public ChargeBackPayment clickselectItem()
			{
			...
			public ChargeBackPayment clickApply() throws InterruptedException
			{
				Thread.sleep(4000);
			...
			public ChargeBackPayment clickCourseTitle() throws InterruptedException
			{
				Thread.sleep(4000);
			...
			public ChargeBackPayment clickDescription() throws InterruptedException {
				driver.switchTo().frame("course_raw_data_ifr").findElement(By.id("tinymce")).sendKeys("Testing Automation");
				Thread.sleep(4000);
				driver.switchTo().parentFrame();
				return new ChargeBackPayment(driver, test);
			}
			
				//Click on Price radio button
				public ChargeBackPayment clickPriceButton1(String Title) throws InterruptedException
				{
					Thread.sleep(4000);
				...
				public ChargeBackPayment clickSave1Button() throws InterruptedException {
					...
					public ChargeBackPayment clickCatalogMenu() throws InterruptedException {
						Thread.sleep(3000);
					...
					public ChargeBackPayment enterText(String Title) throws InterruptedException, AWTException {
					...
					public ChargeBackPayment AddToCart() throws InterruptedException {
						clickByXpath(prop.getProperty("Payments.AddToCart.Xpath"));
						return this;
					}
					
					public ChargeBackPayment clickPay() throws InterruptedException {
						Thread.sleep(4000);
					...
					public ChargeBackPayment switchframes() {
					...
					public ChargeBackPayment cardNumber() throws InterruptedException {
					...
					public ChargeBackPayment MonthYearCVV() throws InterruptedException {
						String Testdata3 = "10";
						String Testdata4 = "20";
					...
					public ChargeBackPayment BillingAddress() {
					...
					public ChargeBackPayment country(){
						String value="3";
					...
					public ChargeBackPayment NextButton() throws InterruptedException {
						Thread.sleep(3000);
					...
					public ChargeBackPayment emailaddress(String email) throws InterruptedException {
